...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('users', '0004_alter_address_options_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sku', models.ForeignKey(db_column='sku_id', on_delete=django.db.models.deletion.CASCADE, to='goods.sku', verbose_name='SKU')),
            ],
            options={
                'verbose_name': '订单商品',
